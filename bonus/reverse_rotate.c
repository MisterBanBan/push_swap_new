...
void	reverse_rotate_a(int *tab_a, size_t count_a)
{
	int	c;
...
void	reverse_rotate_b(int *tab_b, size_t count_b)
{
	int	c;
...
void	reverse_rotate_r(int *tab_a, int *tab_b, size_t count_a, size_t count_b)
{
